...
#         print(ex)
#         print(
#             "Make sure the SMTP_LOGIN and SMTP_PASS credentials have been set correctly in config.py."
#         )
#         return False
#     else:
...
def about():
    return render_template(
        "about.html", year=get_current_year(), logged_in=current_user.is_authenticated
    )
...
def contact():
    ...
    return render_template(
        "contact.html", year=get_current_year(), logged_in=current_user.is_authenticated
    )
